...
/*public class MainActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mapAPI = googleMap;
        LatLng Navsari = new LatLng(20.945001683901364, 72.95134226652225);
        mapAPI.addMarker(new MarkerOptions().position(Navsari).title("Navsari"));
        mapAPI.moveCamera(CameraUpdateFactory.newLatLng(Navsari));
    }
}*/
/*
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] placeNameLlist = {"ATM", "Bank", "Hospital", "Restaurant"};
        spType.setAdapter(new ArrayAdapter<>(MainActivity.this, android.R.layout.simple_spinner_dropdown_item, placeNameLlist));
        ...
        btfind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "https://maps.googleapis.cpm/maps/api/place/nearbysearch/json" +
